<div class="btn-group" role="group">
    ...
    <a class="btn @if(!empty($cara_bayar_kasir)) btn-info print @else btn-default btn-disabled @endif btn-xs btn-3d"
        data-id-cetak="{{ $id}}" @if(!empty($cara_bayar_kasir)) data-route="{{ route('cashiers.printOut') }}" @endif><em
