...
function load_formAdd() {
    ...
    cont.load(base_url + '/slides/add', function (e, s, f) {
        if (s == 'error') {
...
function load_data() {
    ...
    $(".display-future").addClass('blocking-content');
    cont.load(base_url + '/slides/data', function (e, s, f) {
        if (s == 'error') {
...
function getImg(data, type, full, meta) {
    var img = !data ? '/images/noimage.jpg' : '/storage/master-data/slide/uploads/' + data;
...
function submit(page) {
    $("form#formSlide").submit(function (e) {
        e.preventDefault();
