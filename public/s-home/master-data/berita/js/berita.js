...
function load_formAdd() {
    ...
    cont.load(base_url + '/news/add', function (e, s, f) {
        if (s == 'error') {
...
function load_data() {
    ...
    $(".display-future").addClass('blocking-content');
    cont.load(base_url + '/news/data', function (e, s, f) {
        if (s == 'error') {
...
function getImg(data, type, full, meta) {
    var img = !data ? '/images/noimage.jpg' : '/storage/master-data/berita/uploads/' + data;
    return '<img onerror="imgError(this);" width="100" height="55" src="' + base_url + img + '">';
}
...
function submit(page) {
    $("form#formBerita").submit(function (e) {
        e.preventDefault();
