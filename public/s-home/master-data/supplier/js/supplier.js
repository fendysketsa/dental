...
function load_formAdd() {
    ...
    cont.load(base_url + '/suppliers/add', function (e, s, f) {
        if (s == 'error') {
...
function load_data() {
    ...
    $(".display-future").addClass('blocking-content');
    cont.load(base_url + '/suppliers/data', function (e, s, f) {
        if (s == 'error') {
